...
/// Markdown, and the discussion from the preview Comments API. Read-only in
/// this milestone.
            ...
            child: ContentColumn(
              child: ListView(
                ...
                children: [
                  ...
                  if (item != null) ...[
                    _Header(item: item, visuals: _visuals),
                    _Facts(item: item),
...
class _Header extends StatelessWidget {
  const _Header({required this.item, required this.visuals});

...
final class AppleConfig {
  ...
  /// Client capabilities advertised to Entra, e.g. `['CP1']` to declare
  /// Continuous Access Evaluation support. Android reads the same value from
  /// `client_capabilities` in the MSAL configuration JSON.

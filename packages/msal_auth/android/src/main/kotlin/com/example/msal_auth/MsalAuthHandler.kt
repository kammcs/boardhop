    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "acquireToken" -> {
                ...
                val claims: String? = call.argument("claims")
                ...
                Thread { acquireToken(scopes, prompt, loginHint, authority, claims, result) }.start()
            }
            ...
            "acquireTokenSilent" -> {
                ...
                val authority: String? = call.argument("authority")
                val claims: String? = call.argument("claims")
                val forceRefresh: Boolean = call.argument<Boolean>("forceRefresh") ?: false
                Thread { acquireTokenSilent(scopes, identifier, authority, claims, forceRefresh, result) }.start()
            }
        ...
        msal.activity.let {
            ...
            builder.startAuthorizationFromActivity(it)
                ...
                .apply {
                    ...
                    if (claims != null) withClaims(ClaimsRequest.getClaimsRequestFromJsonString(claims))
                }
